...
export interface LogRequestLogsListParams {
  environment?: string;
  tenantId?: string;
  page?: number;
  pageSize?: number;
...
export class LogRequestLogsApi {
...
/** log.requestLogs.list */
  async list(params?: LogRequestLogsListParams, requestOptions?: ApiRequestOptions): Promise<SdkWorkPageData> {
...
export function createLogApi(client: HttpClient): LogApi {
  return new LogApi(client);
}
